<?php
    class VenixsAdminConfig {
        ...
        public function __construct( $plugin_name, $version )
        {
            ...
            add_action( 'admin_menu', 'venixsplugin_add_settings_page' );
            
            add_action( 'admin_init', 'venixsplugin_register_setting_page' );
            ...
            function venixsplugin_add_settings_page()
            {
                add_menu_page(
                    ...
                    'venixs_wpplugin_settings_page_markup',
                    plugins_url('../../resources/src_images/logo.png', __FILE__),
                    5
                );
                
                add_submenu_page('venixs_checkout', __( 'Configuration', 'venixs_checkout' ), __( 'Configuration', 'venixs_checkout' ), 'manage_options', 'edit.php?post_type=venixs_config', 'venixs_show_admin_settings_screen');
            }

            function venixs_wpplugin_settings_page_markup()
            {
            ...
            function venixs_show_admin_settings_screen()
            {
    ...
    ?>
            ...
            function venixsplugin_register_setting_page()
            {
        ...
        {
            $settings_link = array(
                '<a href="' . admin_url('admin.php?page=edit.php?post_type=venixs_config') . '">' . __('Configuration', $this->plugin_name) . '</a>',
            );
