=== Venixs Verification ===
Contributors: venixs, Os-prog
Tags: venixs, ai chat, support system, support chat
...
Save configuration and toggle on `Developer Configuration` tab and select 'Wordpress' as plugin choice. 
...
== SCREENSHOT ==
1. configuration screen on the admin sector
2. The Widget display on your app
